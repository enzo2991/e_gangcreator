Locales['fr'] = {
    -- default menu
    ["default_menu_title"] = "Menu de creation/modification de gang",
    ["default_menu_option_edit"] = "modification d'un gang",
    ["default_menu_option_creator"] = "Creation d'un gang",
    -- gang list menu
    ["gang_select_title"] = "Selection d'un gang",
    ["gang_select_moneygang"] = "Argent",
    -- gang creator menu 
    ...
    ["stash_gang_password"] = "Mot de passe du coffre de gang",
    ["input_name_gang"] = "Entrez le nom du gang",
    ["input_password_manage_gang"] = "saisir le mot de passe pour la gestion",
